...
class RockPaperScissorsViewController: UIViewController {
    ...
    @IBAction func showHistory(sender: AnyObject) {
        ...
        var storyBoard = UIStoryboard(name: "Main", bundle: nil)
        var histVC = storyBoard.instantiateViewControllerWithIdentifier("HistoryViewController") as! HistoryViewController
        
        // Set the histVC history array
        histVC.history = history
        
        // Present History View Controller
        self.presentViewController(histVC, animated: true, completion: nil)
